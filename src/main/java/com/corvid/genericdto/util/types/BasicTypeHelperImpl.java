...
public class BasicTypeHelperImpl {
    ...
    public boolean isNumericType(Object type) {
        System.out.println(" NUMERIC TYPES " + numericTypes + " input " + type);
     ...
     * It will return true if both sides are in the same category (Numeric, Date or Boolean) otherwise it will use java's
