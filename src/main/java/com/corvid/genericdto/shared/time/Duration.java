...
import com.corvid.genericdto.data.gdto.DurationDeserializer;
import com.corvid.genericdto.data.gdto.DurationSerializer;
import com.corvid.genericdto.shared.Ratio;
...
public class Duration implements Comparable, Serializable {
    ...
    @Embedded
    @AttributeOverrides({
            @AttributeOverride(name = "type.name", column = @Column(name = "UNIT_TYPE")),
            @AttributeOverride(name = "baseType.name", column = @Column(name = "BASE_UNIT_TYPE")),
            @AttributeOverride(name = "factor", column = @Column(name = "UNIT_CONVERSION_FACTOR"))
    })
    ...
    public static Duration of(long howMany, TimeUnit unit) {
        return new Duration(howMany, unit);
    }

    public static Duration of(long howMany, String unit) {
        return new Duration(howMany, TimeUnit.of(unit));
    }
...
//		only valid for days and larger units
    ...
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
    public long getForPersistentMapping_Quantity() {
        return quantity;
    }
    ...
    //Only for use by persistence mapping frameworks
    //<rant>These methods break encapsulation and we put them in here begrudgingly</rant>
    public TimeUnit getForPersistentMapping_Unit() {
        return unit;
    }
